...
var withAuthenticationRequired = (Component, options = {}) => {
  const { OnRedirecting = () => import_react5.default.createElement(import_react5.default.Fragment, null), onBeforeSignin, signinRedirectArgs } = options;
  ...
  const C = (props) => {
    ...
    return auth.isAuthenticated ? import_react5.default.createElement(Component, { ...props }) : OnRedirecting();
  };
  C.displayName = displayName;
  return C;
};
